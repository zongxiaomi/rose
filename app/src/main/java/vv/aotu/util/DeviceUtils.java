...
public class DeviceUtils {
  ...
  private static String getMacAddressByWifiInfo() {
    try {
      WifiManager wifi = (WifiManager) Global.getApplicationContext().getApplicationContext()
  ...
  public static void reboot(String reason) {
    PowerManager mPowerManager =
        (PowerManager) Global.getApplicationContext().getSystemService(Context.POWER_SERVICE);
    try {
