...
public class SizeUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = Global.getApplicationContext().getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(float spValue) {
        final float fontScale = Global.getApplicationContext().getResources().getDisplayMetrics().scaledDensity;
