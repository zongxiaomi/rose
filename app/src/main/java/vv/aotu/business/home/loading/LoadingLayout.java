package vv.aotu.business.home.loading;
...
import vv.aotu.R;
import vv.aotu.business.home.util.Utils;
...
public class LoadingLayout extends FrameLayout {
  ...
  public LoadingLayout(Context context, AttributeSet attrs) {
    ...
    mStartAnimation = getResources().getInteger(android.R.integer.config_longAnimTime);
    TypedArray a =
        context.obtainStyledAttributes(attrs, R.styleable.LoadingLayout);
    isFirstVisible =
        a.getBoolean(R.styleable.LoadingLayout_isFirstVisible, false);
    a.recycle();
  }
  ...
  private void build() {
    ...
    errorPage = LayoutInflater.from(mContext)
        .inflate(R.layout.widget_error_page, null);
    emptyPage = LayoutInflater.from(mContext)
        .inflate(R.layout.widget_empty_page, null);
    networkPage = LayoutInflater.from(mContext)
        .inflate(R.layout.widget_nonetwork_page, null);
    ...
    networkReloadBtn =
        Utils.findViewById(networkPage, R.id.no_network_reload_btn);
    ...
    switch (status) {
      case Success:
        ...
        if (defineLoadingPage != null) {
          ...
          loadingPage.animate().alpha(0f).setDuration(mStartAnimation)
      ...
      case Loading:
        ...
        if (defineLoadingPage != null) {
          ...
          loadingPage.setAlpha(0f);
          loadingPage.animate().alpha(1f).setDuration(mStartAnimation).setListener(null);
        }
        break;
